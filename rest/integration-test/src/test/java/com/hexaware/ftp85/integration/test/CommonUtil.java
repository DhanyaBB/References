...
class LeaveDetails {
   ...
   * leaSdate to store Starting date of leave.
   * leaEdate to store ending date of leave.
   * leaNdays to store No. of days on leave.
  ...
  private Date leaEdate;
  private int leaNdays;
  ...
  public final boolean equals(final Object obj) {
    ...
    if (Objects.equals(leaId, lea.leaId) && Objects.equals(leaSdate, lea.leaSdate)
        && Objects.equals(leaEdate, lea.leaEdate) && Objects.equals(leaNdays, lea.leaNdays)
  ...
  @Override
  public final int hashCode() {
    return Objects.hash(leaId, leaSdate, leaEdate, leaNdays, leaType, leaSta, leaRea, leaAppOn, leaMgrCom, empId);
  }

  @Override
  public final String toString() {
    return "LeaveID" + leaId + "\nLeave Start Date" + leaSdate + "\nLeave End Date" + leaEdate + "No of Leave Days"
  ...
  */
   ...
   * @param argLeaSdate to initialize Starting date of leave.
   * @param argLeaEdate to initialize ending date of leave.
   * @param argLeaNdays to initialize Number of days of leave.
   ...
   * @param argEmpId to initialize employee id.
   */
  public LeaveDetails(final int argEmpId, final int argLeaId, final Date argLeaSdate, final Date argLeaEdate,
      final int argLeaNdays, final LeaveType argLeaType, final LeaveStatus argLeaSta,
      final String argLeaRea, final Date argLeaAppOn, final String argLeaMgrCom) {
    this.empId = argEmpId;
    this.leaId = argLeaId;
    this.leaSdate = argLeaSdate;
    this.leaEdate = argLeaEdate;
    this.leaNdays = argLeaNdays;
    this.leaType = argLeaType;
    this.leaSta = argLeaSta;
    this.leaRea = argLeaRea;
    this.leaAppOn = argLeaAppOn;
