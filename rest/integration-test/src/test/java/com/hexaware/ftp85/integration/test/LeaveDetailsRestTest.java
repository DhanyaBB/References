...
public class LeaveDetailsRestTest {
    ...
    public void testLeaveDetailsById() throws AssertionError, URISyntaxException, ParseException {
        ...
        assertEquals(3000, res.getEmpId());
        assertEquals(LeaveStatus.valueOf("PENDING"), res.getLeaSta());
        assertEquals("SICK", res.getleaRea());
        assertEquals(sdf.parse("2018-11-20"), res.getleaAppOn());
